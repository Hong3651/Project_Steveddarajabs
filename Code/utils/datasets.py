...
class AudioFeatureExtractor:
    ...
    def fit(self, all_features):
        ...
        self.is_fitted = True
        print(f"[INFO] AudioFeatureExtractor fitted on {len(concat)} frames")
    ...
    def save(self, path):
        ...
        print(f"[INFO] AudioFeatureExtractor 저장: {path}")
    ...
    def load(self, path):
        ...
        print(f"[INFO] AudioFeatureExtractor 로드: {path}")
...
class TextEmphasisDataset(Dataset):
    ...
    def _load_stt_data(self):
        ...
        print(f"[INFO] Loaded STT data for {len(stt_data)} videos")
        return stt_data
